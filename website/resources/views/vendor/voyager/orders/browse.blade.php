...
@section('page_header')
    <div class="container-fluid">
        ...
        @endphp
        <form method="get" action="{{ route('voyager.orders.index') }}" style="display: inline-block; margin-left: 15px;">
            <div style="display: flex; align-items: center; gap: 5px;">

                <select name="group_id" class="form-control" style="width: 250px; margin-bottom: 0;">
                    <option value="">-- Lọc theo Nhóm khách hàng --</option>
                ...
                @if (request()->has('group_id') && request('group_id') != '')
                    <a href="{{ route('voyager.orders.index') }}" class="btn btn-danger" style="margin-top: 0;"
                        title="Xóa bộ lọc">
                        <i class="voyager-x"></i>
                    </a>
                @endif
