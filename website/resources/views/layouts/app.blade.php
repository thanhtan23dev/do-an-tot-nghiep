<!DOCTYPE html>
<html lang="vi" x-data="{ darkMode: $persist(false).as('darkMode'), sidebarToggle: false }" :class="{ 'dark': darkMode }">

<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>@yield('title', 'Hệ thống Quản lý Xưởng')</title>
...
<body
    ...
    <div x-data="{
        ...
        showToast(msg, type) {
            ...
            this.type = type;
            this.show = true;
            setTimeout(() => { this.show = false }, 3000); // Tự đóng sau 3 giây
        }
