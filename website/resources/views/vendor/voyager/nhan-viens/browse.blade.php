...
@section('javascript')
    ...
    @endif
    <script>
        function exportWithMonths(event, id) {
            event.preventDefault();
            var months = prompt('Bạn muốn tổng hợp bao nhiêu tháng gần nhất?', '6');
            if (months != null && months.trim() !== '') {
                var url = "{{ url('admin/nhan-viens') }}/" + id + "/export-payroll?months=" + months;
